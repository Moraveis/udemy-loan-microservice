package course.udemy.springboot.loans.controller;

import course.udemy.springboot.loans.constants.LoanConstants;
import course.udemy.springboot.loans.dto.ErrorResponseDto;
import course.udemy.springboot.loans.dto.LoanDto;
import course.udemy.springboot.loans.dto.LoansContactInfoDto;
import course.udemy.springboot.loans.dto.ResponseDto;
import course.udemy.springboot.loans.service.LoanService;
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "Get build version that is deployed into account microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
